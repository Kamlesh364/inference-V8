...
```bash
yolo predict model=yolov8n.pt source="https://ultralytics.com/images/bus.jpg" classes=[0,1,2,...]
```
...
results = model("https://ultralytics.com/images/bus.jpg", classes=[0,1,2,...])  # predict on an image
